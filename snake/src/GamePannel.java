...
public class GamePannel extends JPanel implements ActionListener {
    ...
    int appleX;
    int appleY;
    char direction = 'R';  // for direction of snake going when game starts.
...
public void draw(Graphics g){
        if (running) {
            ...
            for (int i = 0; i < SCREEN_HEIGHT / UNIT_SIZE; i++) {
                ...
                g.drawLine(0, SCREEN_HEIGHT, SCREEN_WIDTH, i * UNIT_SIZE);
            }
            */
            ...
            g.drawString("Score" + applesEaten, (SCREEN_HEIGHT - metrix.stringWidth("Score" + applesEaten))/2, g.getFont().getSize());
        }
        else {
            gameOver(g);
        }
...
public void gameOver(Graphics g){
    ...
    g.drawString("Score" + applesEaten, (SCREEN_HEIGHT - metrix1.stringWidth("Score" + applesEaten))/2, g.getFont().getSize());
        // game over text.
    g.setColor(Color.red);
    g.setFont(new Font("Int Free", Font.BOLD,75));
    FontMetrics metrix2 = getFontMetrics(g.getFont());
    g.drawString("game over", (SCREEN_HEIGHT - metrix2.stringWidth("Game Over"))/2, SCREEN_HEIGHT/2);
